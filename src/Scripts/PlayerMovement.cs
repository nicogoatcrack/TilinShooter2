...
{   
    ...
    private void MyInput()
    {
        ...
        // Eliminado el input de agacharse
    }

    // ELIMINADAS LAS FUNCIONES DE AGACHARSE:
    // - StartCrouch()
    // - StopCrouch()
    ...
    private void Movement()
    {
        ...
        // Eliminada la sección de agacharse
        if (x > 0f && num > num3)
        {
            x = 0f;
        }
        ...
        // Eliminada la condición de agacharse
        if (wallRunning)
        {
            num5 = 0.3f;
            num4 = 0.3f;
    ...
    private void CounterMovement(float x, float y, Vector2 mag)
    {
        ...
        // Eliminada la sección de deslizamiento al agacharse
    ...
    // Eliminado el método IsCrouching()
